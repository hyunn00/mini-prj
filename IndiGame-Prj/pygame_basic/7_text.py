...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/ko/OneDrive/문서/Python mini Prj/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/ko/OneDrive/문서/Python mini Prj/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/ko/OneDrive/문서/Python mini Prj/pygame_basic/enemy.png")
...
# 폰트 정의
game_font = pygame.font.Font(None, 40) # 폰트 객체 생성(폰트, 객체)
